...
public class CustomChest extends Block implements ITileEntityProvider {
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
        ...
        TileEntityCustomChest tile = (TileEntityCustomChest) p_149689_1_
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_,
        ...
        if (tile == null || player.isSneaking()) {
            ...
            if (!this.hasOwner || tile.getOwner()
                .equals(
                    player.getUniqueID()
                        .toString())) {
    ...
    @Override
    public void breakBlock(World world, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_,
        int p_149749_6_) {
        TileEntityCustomChest tileentitychest = (TileEntityCustomChest) world

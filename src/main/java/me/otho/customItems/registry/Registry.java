...
import me.otho.customItems.configuration.jsonReaders.items.tools.*;
...
public class Registry {
    ...
    private static void setCreativeTabs() {
        ...
        for (i = 0; i < itemsList.size(); i += 2) {
            ...
            CreativeTabs tab = customItemsTab.getTabByNameOrDefault((String) itemsList.get(i + 1));
            if (tab != null) {
        ...
        for (i = 0; i < blocksList.size(); i += 2) {
            ...
            CreativeTabs tab = customItemsTab.getTabByNameOrDefault((String) blocksList.get(i + 1));
            if (tab != null) {
    ...
    public static void register(JsonSchema data) {
        ...
        ArrayList<Cfg_basicData> allData = new ArrayList<>();
        ...
        if (data != null) {
            ...
            allData.sort(Comparator.comparing(d -> d.registerOrder));

...
public class BlockRegistry {
    ...
    public static boolean registerCrop(Cfg_crop data) {
        ...
        LanguageRegistry.instance()
            .addStringLocalization(crop.getUnlocalizedName() + ".name", "en_US", data.name);

        GameRegistry.registerItem(seed, registerName + "_seed");
        seed.setUnlocalizedName(Registry.mod_id.toLowerCase() + ":" + registerName + "_seed");
        LanguageRegistry.instance()
            .addStringLocalization(seed.getUnlocalizedName() + ".name", "en_US", data.name + " Seeds");
    ...
    public static boolean registerFluid(Cfg_fluid data) {
        ...
        fluid.setUnlocalizedName(
            fluidBlock.getUnlocalizedName()
                .substring(
                    fluidBlock.getUnlocalizedName()
                        .indexOf(":") + 1));
        LanguageRegistry.instance()
            .addStringLocalization(fluidBlock.getUnlocalizedName() + ".name", "en_US", data.name);
        LanguageRegistry.instance()
            .addStringLocalization(fluid.getUnlocalizedName(), "en_US", data.name);
        ...
        LanguageRegistry.instance()
            .addStringLocalization(bucket.getUnlocalizedName() + ".name", "en_US", data.bucket.name);
    ...
    public static void registerSlabBlock(Cfg_block data) {
        ...
        LanguageRegistry.instance()
            .addStringLocalization(slabBlock.getUnlocalizedName() + ".name", "en_US", data.name);

        // Register double slab block
        GameRegistry
            .registerBlock(doubleBlock, CustomSlabItem.class, "double_" + registerName, slabBlock, doubleBlock, true);
        doubleBlock.setBlockName(Registry.mod_id.toLowerCase() + ":" + "double_" + registerName);
        LanguageRegistry.instance()
            .addStringLocalization(doubleBlock.getUnlocalizedName() + ".name", "en_US", data.name);
    ...
    public static void genericBlockSetup(Cfg_block data, IMMBlock block, boolean register, boolean creativeTab) {
        ...
        if (register) {
            ...
            LanguageRegistry.instance()
                .addStringLocalization(mineBlock.getUnlocalizedName() + ".name", "en_US", data.name);
        }
